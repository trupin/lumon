...
BUILTIN_SIGS: dict[str, tuple[tuple[object, ...], object]] = {
    ...
    "text.encode_url": ((TText(),), TText()),
    "text.decode_url": ((TText(),), TText()),
    "text.encode_base64": ((TText(),), TText()),
    "text.decode_base64": ((TText(),), TText()),
    "text.match_pattern": ((TText(), TAny()), TBool()),
    "text.find_pattern": ((TText(), TAny()), TList(TText())),
    # list.*
    ...
    "list.any": ((TList(_A), TFn((_A,), TBool())), TBool()),
    "list.all": ((TList(_A), TFn((_A,), TBool())), TBool()),
    "list.zip": ((TList(_A), TList(_B)), TList(TMap())),
    "list.enumerate": ((TList(_A),), TList(TMap())),
    "list.group_by": ((TList(_A), TFn((_A,), TText())), TMap()),
    "list.index_of": ((TList(_A), _A), TUnion((TNumber(), TNone()))),
    "list.unique_by": ((TList(_A), TFn((_A,), TAny())), TList(_A)),
    # map.*
    ...
    "map.map": ((TMap(), TFn((TText(), TAny()), TAny())), TMap()),
    "map.filter": ((TMap(), TFn((TText(), TAny()), TBool())), TMap()),
    "map.from_entries": ((TList(TMap()),), TMap()),
    "map.size": ((TMap(),), TNumber()),
    # number.*
    ...
    "number.range": ((TNumber(), TNumber()), TList(TNumber())),
    "number.pi": ((), TNumber()),
    "number.e": ((), TNumber()),
    "number.inf": ((), TNumber()),
    # type.*
